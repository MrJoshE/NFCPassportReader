...
//        passportReader.readPassport(mrzKey: mrzKey, tags:dataGroups, completed: { (passport, error) in
        ...
        Task {
            ...
            do {
                let passport = try await passportReader.readPassport( mrzKey: mrzKey, challenge: [225,10,13,42,225,10,13,42], useExtendedMode: false,  customDisplayMessage:customMessageHandler)
